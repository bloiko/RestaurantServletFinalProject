...
public class FoodListDAO implements FoodDAOInterface {
    ...
    private FoodListDAO() {
        ...
        foodItems.add(new FoodItem(1, "Burger", 20, "https://burgersushipoint.com.ua/wp-content/uploads/2021/02/burger-sushi-point_meny_17-2-500x500.jpg", 1));
        foodItems.add(new FoodItem(2, "Cheese Burger", 15, "https://simply-delicious-food.com/wp-content/uploads/2015/07/Bacon-and-cheese-burgers-3-500x500.jpg", 5));
        foodItems.add(new FoodItem(3, "Potato free", 30, "https://i.pinimg.com/736x/31/7f/f6/317ff60cbdfe3d07e29062f278c529c0.jpg", 2));
    }
