...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <form action="/RegistrationController" method="post">
        ...
        <div class="form-group input-group">
            ...
            <input name="first_name" class="form-control" placeholder="<fmt:message key="registration.first_name"/>"
        ...
        <div class="form-group input-group">
            ...
            <input name="last_name" class="form-control" placeholder="<fmt:message key="registration.last_name"/>"
        ...
        <div class="form-group input-group">
            ...
            <input name="email" class="form-control" placeholder="<fmt:message key="registration.email"/>" type="text"
                   value="${email}">
        </div>
        <div class="form-group input-group">
            <div class="input-group-prepend">
            ...
            <input name="address" class="form-control" placeholder="<fmt:message key="registration.address"/>"
        ...
        <div class="form-group input-group">
            ...
            <input name="phoneNumber" class="form-control" placeholder="<fmt:message key="registration.phone_number"/>"
